...
const steps = [
  {
    ...
    description: "Ship your products to our secure warehouse facilities. We'll receive and catalog everything."
  },
  {
    icon: Warehouse,
    title: "We Store & Track",
    description: "Your inventory is safely stored and tracked in real-time through our dashboard."
  },
  {
    icon: ShoppingBag,
    title: "We Pick & Pack Orders",
    description: "When orders come in, our team picks, packs, and quality-checks each one."
  },
  {
    icon: Truck,
    title: "We Ship Worldwide",
    description: "Fast, reliable shipping to customers anywhere in the world with full tracking."
  }
];
    ...
    <section id="how-it-works" className="py-20 lg:py-32 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl mb-4 text-slate-900">How It Works</h2>
          <p className="text-xl text-slate-600">
            Get started in 4 simple steps. We make fulfillment easy so you can focus on growing your business.
          </p>
        </div>
